...
public class MainActivity extends Activity {
    ...
    private int currentTab = TAB_MEETINGS;
    ...
    private void openZipPicker() {
        ...
        try {
            startActivityForResult(
                Intent.createChooser(intent, getString(R.string.pick_zip_hint)), REQUEST_ZIP);
        } catch (Exception e) {
            intent.setType("*/*");
            startActivityForResult(
                Intent.createChooser(intent, getString(R.string.pick_zip_hint)), REQUEST_ZIP);
    ...
    private void updateTabUi() {
        ...
        if (currentTab == TAB_PREACHING) {
            ...
            subtitleView.setText(R.string.talks_subtitle);
