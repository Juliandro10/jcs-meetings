...
public final class BiblePanel {
    ...
    public static void loadReference(final Host host, final BibleLinkParser.Target target) {
        ...
        if (!BiblePrefs.hasJwpub(context)) {
            showEmpty(host, activity.getString(com.jcs.read2.R.string.bible_jwpub_missing));
            return;
        }
                            ...
                            activity.runOnUiThread(
                                new Runnable() {
                                    ...
                                    public void run() {
                                        ...
                                        showEmpty(
                                            host,
                                            activity.getString(com.jcs.read2.R.string.bible_load_failed));
                                    }
                                });
                        }
                    }
