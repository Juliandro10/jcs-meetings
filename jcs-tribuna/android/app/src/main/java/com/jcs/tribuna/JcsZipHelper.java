...
public final class JcsZipHelper {
    ...
    public static final int IMPORT_COPY_FAILED = 1;
    public static final int IMPORT_EXTRACT_FAILED = 2;
    public static final int IMPORT_INVALID_PACKAGE = 3;
    public static final int IMPORT_NOT_ZIP = 4;

    private JcsZipHelper() {}

    /** Copia o zip, extrai em filesDir/jcs_read_package e retorna a pasta raiz do pacote. */
    public static int importZip(Context context, Uri uri) {
        ...
        if (!looksLikeZipFile(zipFile)) {
            return IMPORT_NOT_ZIP;
        }
    ...
    private static boolean looksLikeZipFile(File file) {
