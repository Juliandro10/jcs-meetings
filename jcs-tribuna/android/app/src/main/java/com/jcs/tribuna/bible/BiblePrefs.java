...
public final class BiblePrefs {
    private static final String PREFS = "tribuna_bible_prefs";
    ...
    public static String getTextZoomLabel(Context context) {
        switch (getTextZoomIndex(context)) {
            case 0:
                return context.getString(com.jcs.tribuna.R.string.text_size_small);
            case 2:
                return context.getString(com.jcs.tribuna.R.string.text_size_large);
            case 3:
                return context.getString(com.jcs.tribuna.R.string.text_size_xlarge);
            default:
                return context.getString(com.jcs.tribuna.R.string.text_size_normal);
        }
    }
}
