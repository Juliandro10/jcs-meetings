...
export const JW_CHAIRMAN_PREP_RULES = [
  ...
  '- openingPreview.treasuresHighlight: identifique a SEÇÃO ("Em Tesouros da Palavra de Deus, na parte 1..." ou "no discurso de Tesouros...") e destaque o TEMA do discurso (parte 1, ~10 min) — 2-3 frases.',
  '- openingPreview.lifeChristianHighlight: identifique a SEÇÃO ("Em Nossa vida cristã...") e destaque brevemente a parte principal de vida cristã (geralmente 15 min; se houver mais de uma parte curta, escolha a de 15 min, não o estudo bíblico de congregação) — 2-3 frases.',
  ...
  '',
  '### Partes de estudante (ministério e leitura da Bíblia)',
  '- Quando houver lessonSummary no contexto: o comentário público (transition) deve mencionar o PONTO PRINCIPAL da lição.',
  '- Comente como o estudante aplicou ou tentou aplicar esse ponto (tom encorajador).',
  '- Se não souber se atingiu o ponto: diga de forma genérica como aquele ponto pode ajudar todos na pregação.',
  '- privateSuggestion: 1–2 frases práticas para falar COM O ESTUDANTE depois da reunião (não ler na tribuna).',
].join('\n');
